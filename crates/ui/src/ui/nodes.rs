use node_model::{
    math::{OneMinusNode, Ops},
    vector::DecomposeNode,
    BinOpNode, CameraPositionNode, ComposeNode, Dim, FloatNode, OutputNode, VecNode, VertexInNode,
};
...
impl<T> NodeView<T> for OneMinusNode<T> {
    fn has_body(&self) -> bool {
        false
    }
